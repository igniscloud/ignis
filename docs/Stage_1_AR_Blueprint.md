...
- [x] [BLD-05] Redesign `ignis project sync` around an explicit plan/apply model so manifest drift is inspectable and eventually repairable rather than merely reported.
